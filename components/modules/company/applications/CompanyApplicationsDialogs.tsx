...
export function CompanyApplicationsDialogs({
  ...
  return (
    <Dialog open={isConventionModalOpen} onOpenChange={handleCloseModal}>
      <DialogContent className="my-6 p-4 h-full overflow-auto">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <h3 className="text-sm font-medium">Formulaire de convention</h3>
            <Form {...form}>
          ...
          <div className="space-y-2">
            <h3 className="text-sm font-medium">Ou uploader un PDF</h3>
