...
export function ChatMessageList({
  ...
  const currentUserIdFromStore = useChatStoreV2((s) => s.currentUserId);
  const currentUserId = currentUserIdFromStore ?? Number(session?.user?.id);
                  ...
                  {!message.isDeleted && (
                    <div
                      className={cn(
                        ...
                        isOwn ? "-left-8 right-auto" : "-right-8 left-auto"
                      )}
                    >
                      <DropdownMenu>
